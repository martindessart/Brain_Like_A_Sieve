...
adjust <- 7 #frames to adjust precisely the location of the 1st trial
...
#Manually adjust TRIAL 10:
Sti_range<-Sti_range %>% 
  filter(Trial!=10) %>% 
  add_row(Trial=10,frameD=135590,frameF=frameD+74) %>% 
  arrange(Trial)
...
adjust <- 17 #frames to adjust precisely the location of the 1st trial
